...
5. An error is returned by line 13. On line 13, **result** was declared with **let** inside the **if** block. This prevents it from being accessed outside of the block. 
